...
if test "${envfile}" = "" ; then
	setenv l_envfile 'atriosEnv.txt'
else
...
#   user can also override by specifying an fdtdir=... in atriosEnv.txt
#   try any U-Boot built-in (or pre-set) fdtdir as last resort
# $fdtfile:
#   some boards use a "filename.dts" others use "${vendor}/filename.dts"
#   user can also override by specifying an fdtfile=... in atriosEnv.txt

...
function apt_find_upstream_package_version_and_download_url() {
	...
	case "${GITHUB_MIRROR}" in
		"ghproxy")
			package_info_download_url="https://${GHPROXY_ADDRESS}/https://raw.githubusercontent.com/AtriOS/AtriOS.github.io/refs/heads/data/data/${sought_package_name}.json"
			;;
		*)
			package_info_download_url="https://raw.githubusercontent.com/AtriOS/AtriOS.github.io/refs/heads/data/data/${sought_package_name}.json"
			;;
	esac

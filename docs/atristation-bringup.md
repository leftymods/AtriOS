...
⚠ ВНИМАНИЕ: ручка сейчас ОТКЛЮЧЕНА — фаза B энкодера (AO10) отдана
регулятору 20V усилителей (совпадение со стоком). rotary-poll при
старте напишет «volume knob DISABLED». Решение конфликта — см.
hardware doc, раздел anti-pop.
